export const bulkUpdateTasksTool = {
    ...
    description: 'Update multiple tasks at once. Supports changing status, priority, assignee, and archiving. Useful for triage and pipeline workflows.',
    inputSchema: {
        type: 'object',
        properties: {
            task_ids: {
...
export async function bulkUpdateTasks(client, projectId, args) {
...
//# sourceMappingURL=bulk-update.js.map