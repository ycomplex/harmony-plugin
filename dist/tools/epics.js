...
export async function listEpics(client, projectId) {
...
export async function updateEpic(client, projectId, args) {
    const updates = {};
...
export async function createEpic(client, projectId, userId, args) {
    // Get next position
