...
import { registerWorkflowTransitionsCommand } from './commands/workflow-transitions.js';
...
import { registerBriefCommands } from './commands/briefs.js';
...
registerWorkflowTransitionsCommand(program);
